...
const features = [
  ...
  {
    icon: UploadIcon,
    title: 'Submit Your Own Bot',
    desc: 'Want your bot on the dashboard? Submit a request with your bot\'s details and files. Only approved bots are added — contact redst0ne8 after submitting to speed things up.',
  },
]
...
export default function LandingPage() {
  ...
  return (
    <div className="flex-1 overflow-y-auto">
      ...
      <section className="max-w-6xl mx-auto px-6 py-24">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-stone-400 text-lg md:text-xl leading-relaxed mb-10">
            Over the past few months, Redsotne has spent this time creating and perfecting an all new bot which can do 90% of what other bots can do. No subscriptions, one time payment only [per bot]. With features like ER:LC support, product spaces, moderation, management, and so much more, the possiblities of what you can do are limitless. Click the explore button below to learn more about this bot.
      ...
      <section className="max-w-6xl mx-auto px-6 pb-32 pt-16">
